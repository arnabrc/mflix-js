...
;(async () => {
  try {
    ...
    const host = "mongodb+srv://m220student:m220password@mflix.1osul.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
    ...
    // over the wire!
    const predicate = { $and: [{lastupdated: { $exists: true, $type: "string" }}] }
    const projection = {_id: 0, title: 1, num_mflix_comments: 1}
